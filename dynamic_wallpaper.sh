...
# PURPOSE: Enables Dynamic Wallpapers for Windows Terminal (using Ubuntu)
# AUTHOR:  Chayse McMillan
# DETAILS: 
#
#       1) Save this program as "~/.dynamic_wallpaper.sh"
#
#       2) Run "chmod 777 ~/.dynamic_wallpaper.sh" to update permissions
#
#       3) Open "~/.bashrc" and add the following line:
#           "( . ~/.dynamic_terminal.sh >/dev/null 2>&1 & ) >/dev/null 2>&1"
#
#       4) Configure the desired variables below
...
#       PHOTO_FORMAT        - Your desired photo format (png, jpg, or gif)
#       VALIDATE_IMGS       - Turn on Image Validation
#       VALIDATE_IMG_ORDER  - Validates the images are in order
#       MANUAL_IMG_SHIFT    - Turns off/on auto wallpaper image shift
#
#
#------------------------------------------------------------------------
#                   PLEASE INITIALIZE THE FOLLOWING VARIABLES
#
WINDOWS_USER=""                 # Please initialize
PHOTO_FORMAT="gif"              # Default
VALIDATE_IMGS="1"               # Default
VALIDATE_IMG_ORDER="1"          # Default
AUTO_IMG_SHIFT="1"              # Default
#------------------------------------------------------------------------
#
#
#
# Globals
CONST_BASE="Ubuntu"                                                                 # File base
VALID_FORMATS=("jpg png gif")                                                       # Supported image formats
THE_DIR="/mnt/c/Users/${WINDOWS_USER}/Pictures/${CONST_BASE}/"                      # Photo Dir
